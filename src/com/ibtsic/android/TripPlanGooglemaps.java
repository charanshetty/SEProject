...
public class TripPlanGooglemaps extends FragmentActivity implements
		LocationListener {
...
String routeID=null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
		    routeID = extras.getString("routeput");}
		...
		try {
			...
			for (int i = 0; i < a.length; ++i) {
				...
				points.add(new LatLng(a[i].latitude, a[i].longitude));
