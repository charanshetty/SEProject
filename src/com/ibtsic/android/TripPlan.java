...
public class TripPlan extends Activity {
 ...
 textView1.addTextChangedListener(new TextWatcher() {
	...
	public void addListenerOnButton() {
		...
		buttontripplan = (Button) findViewById(R.id.button_search_trip);

		buttontripplan.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View arg0) {

				Intent intent = new Intent(context, TripPlanTable.class);
